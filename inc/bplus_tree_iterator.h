...
// after the successfull call to this function (return value != NULL), the lps is solely owned by the bplus_tree_iterator, on an abort_error, all the lps pages will be unlocked by the bplus_tree_iterator
