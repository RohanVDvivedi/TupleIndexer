...
#define walk_down_for_iterator_using_key(root_page_id, key, key_element_count_concerned, f_pos, lock_type, bpttd_p, pam_p, transaction_id, abort_error)       walk_down_for_iterator_using(root_page_id, key, 1, key_element_count_concerned, f_pos, lock_type, bpttd_p, pam_p, transaction_id, abort_error)
#define walk_down_for_iterator_using_record(root_page_id, record, key_element_count_concerned, f_pos, lock_type, bpttd_p, pam_p, transaction_id, abort_error) walk_down_for_iterator_using(root_page_id, record, 0, key_element_count_concerned, f_pos, lock_type, bpttd_p, pam_p, transaction_id, abort_error)
