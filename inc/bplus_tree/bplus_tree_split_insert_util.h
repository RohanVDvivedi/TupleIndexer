...
// insertion_index is an optional parameter, if you do not know it set it to INVALID_INDEX, this function inherently does not and will not check for duplicate insertions
