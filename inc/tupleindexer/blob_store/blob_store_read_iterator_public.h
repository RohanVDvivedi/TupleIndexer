...
// peek will not move the iterator forward, you will need to call read_from_blob_store(bsri_p, NULL, data_size, transaction_id, &abort_error); to make it move forward by that many bytes
