...
// returns NULL_PAGE_ID if you are at the end of the scan
uint64_t get_curr_heap_page_id_heap_table_iterator(const heap_table_iterator* hti_p, uint32_t* unused_space);

// returns get_NULL_persistent_page() if you are at the end of the scan
persistent_page lock_and_get_curr_heap_page_heap_table_iterator(const heap_table_iterator* hti_p, int write_locked, const void* transaction_id, int* abort_error);
