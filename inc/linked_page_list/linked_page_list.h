...
// this functions fails if any of the linked_page_lists provided is empty, this is done to ensure that this function does not free any memory, only modified minimal page header information for the merge
