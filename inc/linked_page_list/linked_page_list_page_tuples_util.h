...
// if MERGE_INTO_PAGE1 is called, then upon a successfull merge tuples of page2 are copied at the end of page1
// else uf MERGE_INTO_PAGE2 is called, then upon a successfull merge tuples of page1 are copied at the beginning of page2
