...
int is_next_of_in_linked_page_list(persistent_page* ppage, persistent_page* ppage_test_next, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);
int is_prev_of_in_linked_page_list(persistent_page* ppage, persistent_page* ppage_test_prev, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);

// test if ppage_head->next = ppage_head and ppage_head->prev = ppage_head
int is_singular_head_linked_page_list(persistent_page* ppage_head, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);

// true, if not is_singular_head_linked_page_list AND ppage_head->next == ppage_head->prev
int is_dual_node_linked_page_list(persistent_page* ppage_head, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);
...
persistent_page lock_and_get_next_ppage_in_linked_page_list(persistent_page* ppage, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);
persistent_page lock_and_get_prev_ppage_in_linked_page_list(persistent_page* ppage, const linked_page_list_tuple_defs* lpltd_p, const page_access_methods* pam_p, const void* transaction_id, int* abort_error);
