...
PUBLIC_HEADERS:=bplus_tree.h bplus_tree_tuple_definitions.h bplus_tree_iterator.h sorted_packed_page_util.h data_access_methods.h in_memory_data_store.h page_modification_methods.h unWALed_page_modification_methods.h persistent_page.h
...
#	${AR} $@ ${OBJECTS}
${LIB_DIR}/${LIBRARY} : ./obj/sorted_packed_page_util.o ./obj/unWALed_page_modification_methods.o | ${LIB_DIR}
	${AR} $@ ./obj/sorted_packed_page_util.o ./obj/unWALed_page_modification_methods.o
