...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -ltuplestore -rwlock -lbufferpool -lcutlery
# Archiver
AR:=ar rcs
...
#	${AR} $@ ${OBJECTS}
${LIB_DIR}/${LIBRARY} : ./obj/sorted_packed_page_util.o ./obj/persistent_page_functions.o ./obj/persistent_page_altered.o ./obj/persistent_page_unaltered.o ./obj/persistent_page_altered_util.o ./obj/unWALed_page_modification_methods.o ./obj/in_memory_data_store.o | ${LIB_DIR}
	${AR} $@ ./obj/sorted_packed_page_util.o ./obj/persistent_page_functions.o ./obj/persistent_page_altered.o ./obj/persistent_page_unaltered.o ./obj/persistent_page_altered_util.o ./obj/unWALed_page_modification_methods.o ./obj/in_memory_data_store.o
