...
uint32_t sizeof_LEAF_PAGE_HEADER(const bplus_tree_tuple_defs* bpttd_p)
{
	...
	{
		case 1:
			return get_size_of_page_type_header() + sizeof(bplus_tree_page_header) + sizeof(bplus_tree_leaf_page_header1);
		case 2:
			return get_size_of_page_type_header() + sizeof(bplus_tree_page_header) + sizeof(bplus_tree_leaf_page_header2);
		case 4:
			return get_size_of_page_type_header() + sizeof(bplus_tree_page_header) + sizeof(bplus_tree_leaf_page_header4);
		case 8:
			return get_size_of_page_type_header() + sizeof(bplus_tree_page_header) + sizeof(bplus_tree_leaf_page_header8);
	}
	return 0;
}
