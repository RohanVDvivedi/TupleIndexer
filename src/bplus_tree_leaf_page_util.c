...
int split_insert_bplus_tree_leaf_page(persistent_page page1, const void* tuple_to_insert, uint32_t tuple_to_insert_at, const bplus_tree_tuple_defs* bpttd_p, const data_access_methods* dam_p, void* output_parent_insert)
{
	...
	{
		// if can not insert then compact the page first
		if(!can_append_tuple_on_page(page2.page, bpttd_p->page_size, &(bpttd_p->record_def->size_def), tuple_to_insert))
			run_page_compaction(page2.page, bpttd_p->page_size, &(bpttd_p->record_def->size_def));
...
int merge_bplus_tree_leaf_pages(persistent_page page1, const bplus_tree_tuple_defs* bpttd_p, const data_access_methods* dam_p)
{
	...
	// we are calling the page next to page2 as page 3
	{
		...
		if(page3.page_id != bpttd_p->NULL_PAGE_ID)
		{
			...
			set_next_page_id_of_bplus_tree_leaf_page(page1.page, page3.page_id, bpttd_p);
		...
		else // page2 is indeed the last page
		{
			...
			set_next_page_id_of_bplus_tree_leaf_page(page1.page, bpttd_p->NULL_PAGE_ID, bpttd_p);
		}
		...
		set_prev_page_id_of_bplus_tree_leaf_page(page2.page, bpttd_p->NULL_PAGE_ID, bpttd_p);
		set_next_page_id_of_bplus_tree_leaf_page(page2.page, bpttd_p->NULL_PAGE_ID, bpttd_p);
	}
